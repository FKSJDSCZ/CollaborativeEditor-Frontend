...
var w = process.env.GC !== "false" && process.env.GC !== "0", c = class extends d.Doc {
  ...
  constructor(t, e, s) {
    ...
    this.onUpdateAwareness = ({ added: t, updated: e, removed: s }, n) => {
      var r;
      let o = t.concat(e, s), a = l.encodeAwarenessUpdate(this.awareness, o);
...
var u = class extends A {
   ...
   */
  initialize() {
    this.nsp = this.io.of(/^\/yjs\|.*$/), this.nsp.use(async (t, e) => {
      var s;
      return ((s = this.configuration) == null ? void 0 : s.authenticate) == null || await this.configuration.authenticate(t.handshake) ? e() : e(new Error("Unauthorized"));
    }), this.nsp.on("connection", async (t) => {
      var n;
      let e = t.nsp.name.replace(/\/yjs\|/, ""), s = await this.initDocument(e, t.nsp, (n = this.configuration) == null ? void 0 : n.gcEnabled);
      this.initSyncListeners(t, s), this.initAwarenessListeners(t, s), this.initSocketListeners(t, s), this.startSynchronization(t, s);
    });
  }
  /**
  ...
  async initDocument(t, e, s = !0) {
    var o;
    let n = (o = this._documents.get(t)) != null ? o : new c(t, e, {
      onUpdate: (a, r) => this.emit("document-update", [a, r]),
      onChangeAwareness: (a, r) => this.emit("awareness-update", [a, r]),
      onDestroy: async (a) => {
  ...
  initLevelDB(t) {
    ...
    this.persistence = {
      provider: e,
      bindState: async (s, n) => {
        let o = await e.getYDoc(s), a = i.encodeStateAsUpdate(n);
        await e.storeUpdate(s, a), i.applyUpdate(n, i.encodeStateAsUpdate(o)), n.on("update", async (r) => await e.storeUpdate(s, r));
      },
...
//# sourceMappingURL=chunk-DEBI6Q62.mjs.map