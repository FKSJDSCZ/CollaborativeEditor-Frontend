...
var _ = (n, o) => {
  for (var e in o)
    h(n, e, { get: o[e], enumerable: !0 });
}, w = (n, o, e, t) => {
  if (o && typeof o == "object" || typeof o == "function")
    for (let r of S(o))
      !C.call(n, r) && r !== e && h(n, r, { get: () => o[r], enumerable: !(t = m(o, r)) || t.enumerable });
  return n;
};
var l = (n, o, e) => (e = n != null ? U(g(n)) : {}, w(
  // If the importer is in node compatibility mode or this is not an ESM
  // file that has been converted to a CommonJS file using a Babel-
  // compatible transform (i.e. "__esModule" has not been set), then set
  // "default" to the CommonJS "module.exports" for node compatibility.
  o || !n || !n.__esModule ? h(e, "default", { value: n, enumerable: !0 }) : e,
  n
)), P = (n) => w(h({}, "__esModule", { value: !0 }), n);
...
var s = l(require("yjs")), i = l(require("lib0/broadcastchannel")), a = l(require("y-protocols/awareness")), f = require("lib0/observable"), v = require("socket.io-client"), p = class extends f.Observable {
  /**
  ...
  constructor(e, t, r = new s.Doc(), {
    ...
    this._url = e, this.roomName = t, this.doc = r, this.awareness = c, this._broadcastChannel = `${e}/${t}`, this.disableBc = k, this._socketIoOptions = b, this.socket = (0, v.io)(this.url, {
      autoConnect: !1,
      ...
      this.emit("status", [{ status: "connecting" }]), this.socket.emit("join-room", t, u, (d) => {
        d ? this.onSocketConnection(A) : this.emit("error", [{ message: "Failed to join room" }]);
      });
    }), this.socket.on("disconnect", (d) => this.onSocketDisconnection(d)), this.socket.on("connect_error", (d) => this.onSocketConnectionError(d)), this.initSyncListeners(), this.initAwarenessListeners(), this.initSystemListeners(), c.on("update", this.awarenessUpdate), y && this.connect();
  }
  /**
