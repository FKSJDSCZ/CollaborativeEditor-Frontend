...
var l = class extends u {
  ...
  constructor(e, t, r = new s.Doc(), {
     ...
     */
    this.awarenessUpdate = ({ added: e, updated: t, removed: r }, c) => {
    ...
    this._url = e, this.roomName = t, this.doc = r, this.awareness = i, this._broadcastChannel = `${e}/${t}`, this.disableBc = y, this._socketIoOptions = h, this.socket = b(this.url, {
      autoConnect: !1,
      ...
      this.emit("status", [{ status: "connecting" }]), this.socket.emit("join-room", t, d, (o) => {
        o ? this.onSocketConnection(p) : this.emit("error", [{ message: "Failed to join room" }]);
      });
    }), this.socket.on("disconnect", (o) => this.onSocketDisconnection(o)), this.socket.on("connect_error", (o) => this.onSocketConnectionError(o)), this.initSyncListeners(), this.initAwarenessListeners(), this.initSystemListeners(), i.on("update", this.awarenessUpdate), c && this.connect();
  }
  /**
